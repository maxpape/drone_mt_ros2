...
static const casadi_int casadi_s6[11] = {17, 4, 0, 1, 2, 3, 4, 13, 14, 15, 16};
static const casadi_int casadi_s7[3] = {17, 0, 0};

/* drone_ode_impl_dae_jac_x_xdot_u_z:(i0[17],i1[17],i2[4],i3[],i4[],i5[27])->(o0[17x17,73nz],o1[17x17,17nz],o2[17x4,4nz],o3[17x0]) */
